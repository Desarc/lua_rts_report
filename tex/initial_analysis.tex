...
\section{The advantages of using Lua in a state machine based system}
...
\section{The disadvantages and challenges of using Lua in a state machine based system}
...
\label{sec:lua_comp_script}
The programming languages described here are commonly used as scripting languages.
