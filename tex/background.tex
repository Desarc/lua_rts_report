...
\subsection{Lua compared to other scripting languages}
...
\subsubsection{Advantages with Java}

\paragraph{Speed}

\subsubsection{Disadvantages with Java}

\paragraph{Maintained by Oracle}

\paragraph{Overhead}

\subsection{Why not just use C?}
\label{sec:why_not_c}
