...
\professor{Frank Alexander Kraemer, NTNU Department of Telematics} % Affiliation = ITEM for instance
\supervisor{Frank Alexander Kraemer, NTNU Department of Telematics}
...
\newminted{lua}{linenos, bgcolor=code-bg, baselinestretch=0.7, fontsize=\small, numbersep=4pt, tabsize=2}
\renewcommand{\listingscaption}
\listingscaption{Code snippet}
...
\cleardoublepage
\include{initial_analysis}
\cleardoublepage
\include{experimental_work}
\cleardoublepage
\include{discussion}
\cleardoublepage
